...
sealed interface ImportTarget {
    ...
    /**
     * Create a vault named [name] and put everything in it. Always creates, even when a vault of
     * this name already exists: the user was shown the existing vaults and chose to make a new one.
     */
