...
class CreateVaultUseCaseTest {
    ...
    private val dek = KeyGenerator.getInstance("AES").apply { init(256) }.generateKey().asAesKey()
    private val session = mockk<Session>().apply { every { dek } returns this@CreateVaultUseCaseTest.dek }
