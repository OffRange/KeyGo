...
@Composable
private fun ListItemState.selectedVaultIcon(): Painter = when (selectedVault) {
    SelectedVault.All -> painterResource(de.davis.keygo.core.ui.R.drawable.ic_launcher_monochrome)
