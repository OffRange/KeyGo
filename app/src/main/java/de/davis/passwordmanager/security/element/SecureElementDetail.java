...
public class SecureElementDetail {
    ...
    public SecureElementDetail(Class<? extends CreateSecureElementActivity> createClass, Class<? extends ViewSecureElementActivity> viewClass, @DrawableRes int icon, @StringRes int title) {
    ...
    public static Map<Integer, SecureElementDetail> getRegisteredDetails(){
        ...
        map.put(SecureElement.TYPE_PASSWORD, new SecureElementDetail(CreatePasswordActivity.class, ViewPasswordActivity.class, R.drawable.ic_baseline_password_24, R.string.password));
        map.put(SecureElement.TYPE_CREDIT_CARD, new SecureElementDetail(CreateCreditCardActivity.class, ViewCreditCardActivity.class, R.drawable.ic_baseline_credit_card_24, R.string.credit_card));
