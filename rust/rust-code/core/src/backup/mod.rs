...
pub use encryption::{BackupCredential, KeySource};
...
/// [`CURRENT_VERSION`] is bumped, keep older versions readable here (and
/// preserve their exact AAD/BCS layout - see `encryption::BackupAad`) instead of
